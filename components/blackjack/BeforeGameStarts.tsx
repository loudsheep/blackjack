...
export default function BeforeGameStarts({ players }: BeforeGameStartsProps) {
    return (
        <CommonLayout>
            <h1 className='text-2xl font-semibold m-10'>Waiting for game creator to start the game</h1>
            <div role="status">
